...
# Warnungen kommen sofort. Diese Zeiten sind nur für die spätere Qualitätsmessung.
EVALUATION_WINDOWS = [
    ...
    try:
        ...
        return {
            ...
            "fee_model": {
                ...
                "explanation": "Kaufen wird nur erlaubt, wenn der erwartete Vorteil größer als Gebühren plus Sicherheitspuffer ist.",
            },
